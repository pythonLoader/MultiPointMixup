...
class SageMix:
    ...
    def mix(self, xyz, label, saliency=None, saliency_based=False, mixing_idx=0):
        """
        Args:
            xyz (B,N,3)
            label (B)
...
def train(args, io):
    ...
    wandb.init(
        ...
        project="2-class-mixup-optimal-assignment",
        ...
        "epochs": args.epochs,
        "classes": "2",
        "assignment mechanism": "saliency minimization",
        }
    )
    ...
    for epoch in range(args.epochs):
        ...
        for data, label in tqdm(train_loader):
            ...
            data, label = sagemix.mix(data, label, saliency, saliency_based=saliency_based)
