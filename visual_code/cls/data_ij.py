...
class ModelNet40(Dataset):
    def __init__(self, num_points, cls=None, partition='train', sort=False):
        ...
        if cls is not None:
            idx = []
            for c in cls:
                idx.append(np.where(self.label==c)[0])
...
class ScanObjectNN(Dataset):
    def __init__(self, num_points, partition='train', aug="default", ver = "easy"):
        self.num_points = num_points
        self.partition = partition 
        self.aug = aug
